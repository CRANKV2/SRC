...
ui_print " ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
  ui_print " "
  sleep 2
  ui_print "▌Completly Reworked Menu!"
   ui_print ""
  sleep 0.5
  ui_print "▌For using NEW SRC MENU"
  sleep 0.5
  ui_print "▌Type 'su -c SRCC' - into Termux!"
ui_print ""
ui_print " ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
sleep 4
ui_print " "
...
[[ "$IS64BIT" == "true" ]] && tar -xf "$MODPATH/src64.tar.xz" -C "$MODPATH" || tar -xf "$MODPATH/src32.tar.xz" -C "$MODPATH"
sleep 2.5
ui_print "║"
...
on_install() {
  ui_print "▌Installing STRP x SRC ▌"
  ui_print " "
  sleep 1
